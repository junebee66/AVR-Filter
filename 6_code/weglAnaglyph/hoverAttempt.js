...
function init() {
    ...
    mtlLoader.load('https://threejsfundamentals.org/threejs/resources/models/windmill_2/windmill-fixed.mtl', (mtl) => {
      ...
      objLoader.load('https://threejsfundamentals.org/threejs/resources/models/windmill_2/windmill.obj', (root) => {
        ...
        // let rootMesh = new THREE.Mesh(root, mtl);
        // rootMesh.position.set(0,0,0);
        // myGridObjects.push(rootMesh);
        // // scene.add(rootMesh);
        // interactionMesh(rootMesh)
...
function mousemove(event){
  ...
  // for(let o=0; o<myGridObjects.length; o++){
  //   myGridObjects[o].position.z = 0;
  // }
