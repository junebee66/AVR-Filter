...
// scene.add(light)
    ...
    // const sphereGeometry = new THREE.SphereGeometry( 1, 4, 2 ); 

    // particles = new THREE.Mesh( sphereGeometry, material );
    scene.add(particles);
